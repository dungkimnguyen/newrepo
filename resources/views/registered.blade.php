...
@section('wrapperClass')  
        ...
        <div class="website-wrapper " id="all_wrapper" style="min-height: 100%">
...
@section('content')
   ...
   <div class="row" style="margin-top: 8em;min-height: 400px">
                               <div class="col-xs-12 col-md-8 col-md-offset-2">
                    <div class="panel panel-info" style="margin-top: 3em">
                        <div class="panel-heading"><h4><strong>Registered!</strong></h4></div>
                        <div class="panel-body bg-info">
                            <div class="row">
                                <div class="col-xs-10 col-xs-offset-1">
                                    <h4 class="text-center text-info"><strong>Your registration is almost complete! Please check your email, as we sent you a verification link. After you
                                        click the link, you will able to login and complete profile right away!</strong></h4>
                                    <blockquote class="blockquote rmF">
                                    
                                        <footer class="blockquote-footer"><cite title="Source Title">The Zinterim Team</cite></footer>
                                    </blockquote>
                                </div>
                            </div>
                        </div>
