...
@section('bodyClass') style="overflow-x: hidden;"  class="page-template-default page page-id-358 wpb-js-composer js-comp-ver-5.1.1 vc_responsive" @endsection
...
@section('content')
            ...
            <div class="row" style="margin-top: 8em;min-height: 350px">
                        ...
                        <div class="panel-body bg-info">
                            <div class="row" >
                                <div class="col-xs-10 col-xs-offset-1">
                                    <h4 class="text-center text-info"><strong>Your account is now activated please <button onclick="toggle_F('loginmodal')"> Login </button> and complete profile upon login.</strong></h4>
